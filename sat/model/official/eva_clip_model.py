...
from sat.model.official.vit_model import (
    ImagePatchEmbeddingMixin,
    InterpolatedPositionEmbeddingMixin,
    ViTProperty,
    gelu,
)
    ...
    class XAttn(BaseMixin):
        ...
        def attention_fn(
            ...
            **kwargs
            ...
            dropout_p = 0.0  # xformers does not support dropout for eva hidden size

            query_layer = query_layer.permute(
                0, 2, 1, 3
        ...
        def attention_forward(self, hidden_states, mask, **kw_args):
            ...
            mixed_raw_layer = mixed_raw_layer.reshape(
                B, N, 3, self.num_attention_heads_per_partition, -1
            ).permute(
                2, 0, 3, 1, 4
            )  # 3, B, num_heads, N, C
