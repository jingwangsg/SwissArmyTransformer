...
class ChatGLM3AttnMixin(BaseMixin):
    def __init__(self, hidden_size, num_heads, max_seq_len, base_scale):
        super().__init__()
        rotary_dim = hidden_size // num_heads
        self.rotary_pos_emb = FastRotaryEmbedding(
            rotary_dim // 2, interleaved=True, base=10000 * base_scale
        )
    ...
    def attention_forward(self, hidden_states, mask, **kw_args):
        ...
        query_layer, key_layer = origin.rotary_pos_emb(
            query_layer, key_layer, kw_args["position_ids"], max_seqlen=max_seq_len
        )
...
class ChatGLM3Model(BaseModel):
    def __init__(self, args, transformer=None, **kwargs):
        super(ChatGLM3Model, self).__init__(
            args,
