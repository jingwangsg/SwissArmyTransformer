            ...
            self.transformer = BaseTransformer(
                ...
                **args_dict,
                ...
                device=(
                    ...
                    and args.use_gpu_initialization
        ...
        **kwargs,
        ...
        if build_only or "model_parallel_size" not in overwrite_args:
            ...
            if (
                ...
                assert (
                    world_size % new_model_parallel_size == 0
                ...
                world_size = torch.distributed.get_world_size()
                assert (
                    world_size == model_args.model_parallel_size
    ...
    def get_args(cls, **kwargs):
        ...
        for k, v in kwargs.items():
            if hasattr(args, k) or k in [
                ...
                print_rank0(
                    f"warning: Unknown arg {k} for class {cls.__name__}.", level="DEBUG"
                )
                setattr(args, k, v)
        return args
