...
try:
    ...
    from .webds import MetaDistributedWebDataset, SimpleDistributedWebDataset

except ModuleNotFoundError as e:  # webdataset not install, use pip to install
    from sat.helpers import print_rank0

    print_rank0(
        "webdataset not install, use pip to install, or you cannot use SimpleDistributedWebDataset and MetaDistributedWebDataset.",
        level="INFO",
    )
