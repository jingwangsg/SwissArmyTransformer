...
from sat.data_utils import MetaDistributedWebDataset, SimpleDistributedWebDataset
...
test_metads_batch(
    "/mnt/shared/img_datasets/clay1b_dataset/coyo_700m_merged_cleaned_wds/part-00000/000000.tar"
)
