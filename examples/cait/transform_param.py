...
import torch
from config.cait_config import args, vit
...
def transform_weight(src_model, swiss_model):
    ...
    for ind, src_l, dst_l in zip(
        range(len(src_model.blocks)),
        src_model.blocks,
        swiss_model.encoder.transformer.layers,
    ):
    ...
    for ind, src_l, dst_l in zip(
        range(len(src_model.blocks_token_only)),
        src_model.blocks_token_only,
        swiss_model.decoder.transformer.layers,
    ):
