...
dpr = DPRQuestionEncoder.from_pretrained(
    os.path.join("", model_type), output_hidden_states=True
)
tokenizer = DPRQuestionEncoderTokenizer.from_pretrained(os.path.join("", model_type))
