...
def get_one_query_meanattn(vis_attn, h_featmap, w_featmap):
    ...
    mean_attentions = (
        nn.functional.interpolate(
            mean_attentions.unsqueeze(0).unsqueeze(0), scale_factor=16, mode="nearest"
        )[0]
        .cpu()
        .numpy()
    )
...
def get_args_parser():
    ...
    parser.add_argument(
        "--coco_path", default="/data/qingsong/dataset/coco", type=str, help="split"
    )
    parser.add_argument("--image_set", default="val", type=str, help="split")
    parser.add_argument(
        "--pre_trained",
        default="",
...
parser = argparse.ArgumentParser(
    "Visualize Self-Attention maps", parents=[get_args_parser()]
)
