...
def transform_weight(hugging_model, swiss_model):
    copy_layer_param(
        hugging_model.transformer.wte, swiss_model.transformer.word_embeddings
    )
    copy_layer_param(
        hugging_model.transformer.wpe, swiss_model.transformer.position_embeddings
    )
    copy_layer_norm(hugging_model, swiss_model)
    for src_l, dst_l in zip(
        hugging_model.transformer.h, swiss_model.transformer.layers
    ):
