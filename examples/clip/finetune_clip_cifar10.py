...
def forward_step(data_iterator, model, args, timers):
    ...
    logits = model(
        tokens, position_ids, attention_mask, image=images, offline=True, mask_ratio=0.0
    )
...
if __name__ == "__main__":
    ...
    py_parser = CLIP_finetune.add_model_specific_args(py_parser)
    ...
    swiss_model = CLIP_finetune(
        swiss_model, args.projection_dim, args.num_finetune_classes
    )
    if args.fp16:
        swiss_model.half()
    elif args.bf16:
